...
export default function GaleriaPage() {
    ...
    function renderImageCards() {
        //return images.map(image => image.name); neste caso o map retorna apenas o nome da imagem.
        ...
        <Template loading={loading}>
            <section className="flex flex-col items-center justify-center my-5">
                <div className="fles space-x-4">
                    <InputText placeholder="Type Name or Tags" style="border px-3 py-2 rounded-lg text-gray-900" onChange={event => setQuery(event.target.value)} />
                    {/*<input type="text"
